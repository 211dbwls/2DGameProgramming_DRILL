...
def enter():
    ...
    server.grounds = [Ground(18, 155, 16, 17, 8 + 15 * i, 7) for i in range(0, 69)] \
              + [Ground(18, 155 + 17, 16, 16, 8 + 15 * i, 7 + 16) for i in range(0, 69)] \
              + [Ground(35, 155, 15, 17, 8 + 1035, 7)] \
              + [Ground(35, 155 + 17, 16, 16, 8 + 1035, 7 + 16)] \
              + [Ground(2, 155, 16, 17, 8 + 1095, 7)] \
              + [Ground(2, 155 + 17, 16, 16, 8 + 1095, 7 + 16)] \
              + [Ground(18, 155, 16, 17, 8 + 1110 + 15 * i, 7) for i in range(0, 15)] \
              + [Ground(18, 155 + 17, 16, 16, 8 + 1110 + 15 * i, 7 + 16) for i in range(0, 15)] \
              + [Ground(35, 155, 15, 17, 8 + 1335, 7)] \
              + [Ground(35, 155 + 17, 16, 16, 8 + 1335, 7 + 16)] \
              + [Ground(2, 155, 16, 17, 8 + 1395, 7)] \
              + [Ground(2, 155 + 17, 16, 16, 8 + 1395, 7 + 16)] \
              + [Ground(18, 155, 16, 17, 8 + 1410 + 15 * i, 7) for i in range(0, 80)] \
              + [Ground(18, 155 + 17, 16, 16, 8 + 1410 + 15 * i, 7 + 16) for i in range(0, 80)] \
              + [Ground(35, 155, 15, 17, 8 + 2610, 7)] \
              + [Ground(35, 155 + 17, 16, 16, 8 + 2610, 7 + 16)] \
              + [Ground(2, 155, 16, 17, 8 + 2670, 7)] \
              + [Ground(2, 155 + 17, 16, 16, 8 + 2670, 7 + 16)] \
              + [Ground(18, 155, 16, 17, 8 + 2685 + 15 * i, 7) for i in range(0, 61)] \
              + [Ground(18, 155 + 17, 16, 16, 8 + 2685 + 15 * i, 7 + 16) for i in range(0, 61)]
