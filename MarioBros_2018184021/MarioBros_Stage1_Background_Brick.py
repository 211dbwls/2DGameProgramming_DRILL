...
class Brick:  # 벽돌
    ...
    def draw(self):
        ...
        self.image.clip_draw(68, 36, 17, 16, 332 - Move_locX, 107)  # 깨짐
        self.image.clip_draw(68, 36, 17, 16, 364 - Move_locX, 107)

        self.image.clip_draw(68, 36, 17, 16, 1185 - Move_locX, 107)  # 깨짐
        self.image.clip_draw(68, 36, 17, 16, 1217 - Move_locX, 107)  # 깨짐
