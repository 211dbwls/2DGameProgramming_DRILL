...
class Boy:
    ...
    def collide_brick(self, movex, collide_loc_left, collide_loc_right, collide_loc_y):
        if self.x < collide_loc_left:  # 발판 내에서만 이동하도록
            self.x = collide_loc_left
        elif self.x > collide_loc_right:
            self.x = collide_loc_right
        # else:
        #     self.x = movex
        self.y = collide_loc_y
